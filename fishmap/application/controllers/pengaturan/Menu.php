...
class Menu extends ApplicationBase
{
    ...
    public function index()
    {
        ...
        $this->smarty->assign("template_content", "pengaturan/menu/index.html");

        // load style js
        $this->smarty->load_style('menu/css/style.css');
        $this->smarty->load_style('menu/css/bootstrap.min.css');
        //
        // $this->smarty->load_javascript('menu/js/jquery.min.js');
        $this->smarty->load_javascript('menu/js/jquery-ui-1.10.3.custom.min.js');
        $this->smarty->load_javascript('menu/js/jquery.mjs.nestedSortable.js');
        $this->smarty->load_javascript('menu/js/menu.js');
        $this->smarty->load_javascript('menu/js/bootstrap.min.js');
        ...
        $this->smarty->assign('menu_groups', $data['menu_groups']);
        $this->smarty->assign('group_title', $data['group_title']);
        $this->smarty->assign('group_id', $data['group_id']);
        $this->smarty->assign('menu_ul', $data['menu_ul']);
        // notification
    ...
    public function edit($id)
    {
        ...
        $this->_set_page_rule("U");
        // set template content
        // $this->smarty->assign("template_content", "pengaturan/menu/edit.html");
        ...
        //
        $this->smarty->assign('row', $data['row']);
        $this->smarty->assign('menu_groups', $data['menu_groups']);
        // notification
        $this->tnotification->display_notification();
        // output
        // parent::display();
        $this->load->view('pengaturan/menu/edit.html', $data);
    }
    ...
    public function getList()
    {
        ...
        //
        $response = $this->manager->getList([$searchTerm, $searchTerm]);
        //
        echo json_encode($response);
    }
}
