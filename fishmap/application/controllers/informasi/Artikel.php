...
class Artikel extends ApplicationBase
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        // load model
        $this->load->model('informasi/M_artikel');
    ...
    public function index()
    {
        ...
        $this->smarty->assign("template_content", "informasi/artikel/index.html");
        // load js                                       
        ...
        $search = $this->tsession->userdata('search_data_artikel');
        ...
        $config['base_url'] = site_url("informasi/artikel/index/");
        $config['total_rows'] = $this->M_artikel->get_total_artikel($params);
        ...
        $rs_id = $this->M_artikel->get_artikel($params, $limit);
    ...
    public function add()
    {
        ...
        $rs = $this->M_artikel->insert($params);
        $post_id = $this->db->insert_id();
        redirect('informasi/artikel/edit/' . $post_id . '/add');
    }
    ...
    public function edit($post_id = null, $form = "")
    {
        ...
        // set template content
        $this->smarty->assign("template_content", "informasi/artikel/edit.html");
        // load js        
        ...
        // post
        $result = $this->M_artikel->get_by_id($post_id);
    ...
    public function search_process()
    {
        ...
        if ($this->input->post('save') == "Reset") {
            $this->tsession->unset_userdata('search_data_artikel');
        } else {
            $params = array(
                "post_title" => $this->input->post("post_title"),
                "post_date"  => $this->input->post("post_date")
            );
            $this->tsession->set_userdata('search_data_artikel', $params);
        }
        // default redirect
        redirect($_SERVER['HTTP_REFERER']);
    }
    ...
    public function edit_process()
    {
        ...
        if ($this->tnotification->run() !== false) {
            ...
            // update artikel
            if ($this->M_artikel->update($params, $where)) {
                // parameters file
                if ($file) {
                    $params2 = array(
    ...
    public function delete_process($post_id = null)
    {
        ...
        $rs_informasi = $this->M_artikel->delete($params);
    ...
    public function delete_img($post_id = null)
    {
        ...
        $rs_informasi = $this->M_artikel->update(['post_image' => NULL, 'updated_by' => $this->com_user['user_id']], $params);
        if ($rs_informasi) {
            $this->tnotification->sent_notification("success", "Data berhasil dihapus");
        } else {
            $this->tnotification->sent_notification("error", "Data gagal dihapus");
    ...
    private function _update_img($id = '', $path = null)
    {
        ...
        if (empty($id)) {
            ...
            $rs = $this->M_artikel->update(['post_image' => $path, 'updated_by' => $this->com_user['user_id']], ['post_id' => $id]);
        }
    }
