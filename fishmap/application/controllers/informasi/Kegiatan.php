...
class Kegiatan extends ApplicationBase
{
    ...
    public function __construct()
    {
        ...
        parent::__construct();
        // load model
        $this->load->model('informasi/M_kegiatan');
    ...
    public function index()
    {
        ...
        $this->smarty->assign("template_content", "informasi/kegiatan/index.html");
        // load js                                       
        ...
        $search = $this->tsession->userdata('search_data_kegiatan');
        ...
        $config['base_url'] = site_url("informasi/kegiatan/index/");
        ...
        $rs_id = $this->M_kegiatan->get_kegiatan($params, $limit);
    ...
    public function add()
    {
        ...
        $rs = $this->M_kegiatan->insert($params);
        $post_id = $this->db->insert_id();
        redirect('informasi/kegiatan/edit/' . $post_id . '/add');
    }
    ...
    public function edit($post_id = null, $form = '')
    {
        ...
        // set template content
        $this->smarty->assign("template_content", "informasi/kegiatan/edit.html");
        // load js                              
        ...
        // post
        $result = $this->M_kegiatan->get_by_id($post_id);
    ...
    public function search_process()
    {
        ...
        if ($this->input->post('save') == "Reset") {
            $this->tsession->unset_userdata('search_data_kegiatan');
        } else {
            $params = array(
                "post_title" => $this->input->post("post_title"),
                "post_date"  => $this->input->post("post_date")
            );
            $this->tsession->set_userdata('search_data_kegiatan', $params);
        }
        // default redirect
        redirect($_SERVER['HTTP_REFERER']);
    }
    ...
    public function edit_process()
    {
        ...
        if ($this->tnotification->run() !== false) {
            ...
            // update kegiatan
            if ($this->M_kegiatan->update($params, $where)) {
                // parameters file
                if ($file) {
                    $params2 = array(
    ...
    public function delete_process($post_id = null)
    {
        ...
        $rs_informasi = $this->M_kegiatan->delete($params);
    ...
    public function delete_img($post_id = null)
    {
        ...
        $rs_informasi = $this->M_kegiatan->update(['post_image' => NULL, 'updated_by' => $this->com_user['user_id']], $params);
        if ($rs_informasi) {
            $this->tnotification->sent_notification("success", "Data berhasil dihapus");
        } else {
            $this->tnotification->sent_notification("error", "Data gagal dihapus");
    ...
    private function _update_img($id = '', $path = null)
    {
        ...
        if (empty($id)) {
            ...
            $rs = $this->M_kegiatan->update(['post_image' => $path, 'updated_by' => $this->com_user['user_id']], ['post_id' => $id]);
        }
    }
