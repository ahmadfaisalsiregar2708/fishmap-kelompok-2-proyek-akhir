...
class Video extends ApplicationBase
{
    const PATH_FILE_PUBLIC = 'https://www.youtube.com/embed/';
    const PATH_FILE_PUBLIC_ = 'resource/doc/';
    ...
    public function index()
    {
        ...
        $this->smarty->assign("template_content", "galeri/video/album/index.html");
        // get search parameter
        $search = $this->tsession->userdata('search_data_video');
        ...
        $config['base_url'] = site_url("galeri/video/album/index/");
    ...
    public function add()
    {
        ...
        // set template content
        $this->smarty->assign("template_content", "galeri/video/album/add.html");
        // load js              
        // notification
        $this->tnotification->display_notification();
        $this->tnotification->display_last_field();
    ...
    public function edit($album_id = null)
    {
        ...
        // set template content
        $this->smarty->assign("template_content", "galeri/video/album/index.html");
        $this->smarty->assign("template_content", "galeri/video/album/edit.html");
        /* start of pagination --------------------- */
        // pagination            
        $params = [
            'album_id'    => $album_id
        ];
        $config['base_url'] = site_url("galeri/video/edit/" . $album_id . "/");
    ...
    public function search_process()
    {
        ...
        if ($this->input->post('save') == "Reset") {
            $this->tsession->unset_userdata('search_data_video');
        } else {
            $params = array(
                "album_title" => $this->input->post("album_title")
            );
            $this->tsession->set_userdata('search_data_video', $params);
        }
        // default redirect
        redirect($_SERVER['HTTP_REFERER']);
    }
    ...
    public function add_process()
    {
        ...
        if ($this->tnotification->run() !== false) {
            ...
            if ($this->M_gallery_album->insert($params)) {
                ...
                redirect(site_url('galeri/video/edit/' . $album_id));
            } else {
                // default error
    ...
    public function add_file($album_id = null)
    {
        ...
        $this->_set_page_rule("C");
        // set template content
        $this->smarty->assign("template_content", "galeri/video/file/add.html");
        // load js                      
        // get data 
        $this->smarty->assign("result", $this->M_gallery_files->get_id_album($album_id));
        // notification
    ...
    public function edit_file($file_id = null)
    {
        ...
        // set template content
        $this->smarty->assign("template_content", "galeri/video/file/edit.html");
        // load js                      
        // post
    ...
    public function add_file_process($album_id)
    {
        ...
        $this->tnotification->set_rules('file_url', 'URL', 'trim|max_length[255]|required');
        ...
        if ($this->tnotification->run() !== false) {
            ...
            if ($_FILES['file_path']['name']) {
                ...
                $file_path      = self::PATH_FILE_PUBLIC_ . ($file['file_name'] ?? 'ajax-loader.gif');
            }
            $file_type  = 'video';
            $params = array(
                'album_id'          => $album_id,
    ...
    function _upload_file($input_name)
    {
        // set page rules
        $this->_set_page_rule("C");
        $config['upload_path']          = self::PATH_FILE_PUBLIC_;
