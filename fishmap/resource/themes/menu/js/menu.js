jQuery(function ($) {
    ...
    $('body').on('click', '.edit-menu', function () {
        ...
        console.log(_BASE_URL + 'index.php/pengaturan/menu/edit/' + menu_id);
        var li = $(this).closest('li');
        gbox.show({
            type: 'ajax',
            url: _BASE_URL + 'index.php/pengaturan/menu/edit/' + menu_id,
            buttons: {
                'Save': function () {
                    $.ajax({
                        type: 'POST',
    ...
    $('body').on('click', '.delete-menu', function () {
        ...
        gbox.show({
            ...
            buttons: {
                'Yes': function () {
                    $.post(_BASE_URL + 'index.php/pengaturan/menu/delete', param, function (data) {
                        if (data.success) {
                            gbox.hide();
                            li.remove();
                        } else {
            ...
            buttons: {
                'Save': function () {
                    ...
                    if (group_title === '') {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: _BASE_URL + 'index.php/pengaturan/menugroup/add',
    ...
    $('#edit-group').click(function () {
        ...
        inputgroup.focus().select().keydown(function (e) {
            ...
            if (e.which == 13) {
                ...
                $.ajax({
                    type: 'POST',
                    url: _BASE_URL + 'index.php/pengaturan/menugroup/edit',
    ...
    $('#delete-group').click(function () {
        ...
        gbox.show({
            ...
            buttons: {
                'Yes': function () {
                    $.post(_BASE_URL + 'index.php/pengaturan/menugroup/delete', param, function (data) {
                        if (data.success) {
                            window.location = site_url('pengaturan/menu');
                        } else {
                            gbox.show({
